        ...
        <div>
          ...
          <div class="flex flex-wrap gap-1 px-3 py-2 bg-pac-black-800 border border-pac-black-100 border-b-0">
            <button type="button" @click="toggleBold()"
                    ...
                    class="w-7 h-7 flex items-center justify-center font-display font-bold text-sm transition-colors rounded">
              B
            </button>
            <button type="button" @click="toggleItalic()"
                    ...
                    class="w-7 h-7 flex items-center justify-center font-display italic text-sm transition-colors rounded">
              I
            </button>
            <button type="button" @click="toggleStrike()"
                    ...
                    class="w-7 h-7 flex items-center justify-center font-display text-sm line-through transition-colors rounded">
              S
            </button>
