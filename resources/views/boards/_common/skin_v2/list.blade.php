...
<div class="max-w-5xl mx-auto px-4 py-8 md:px-6 lg:px-8">
  ...
  <div class="border border-[#2a2a2a] bg-[#141414] overflow-hidden">
    ...
    <div class="hidden sm:grid grid-cols-[60px_1fr_120px_100px_60px] gap-x-3 px-5 py-2.5
      ...
      <span class="font-display text-xs tracking-[3px] uppercase text-[#555] text-center">번호</span>
      <span class="font-display text-xs tracking-[3px] uppercase text-[#555]">제목</span>
      <span class="font-display text-xs tracking-[3px] uppercase text-[#555] text-center">작성자</span>
      <span class="font-display text-xs tracking-[3px] uppercase text-[#555] text-center">날짜</span>
      <span class="font-display text-xs tracking-[3px] uppercase text-[#555] text-center">조회</span>
    </div>
